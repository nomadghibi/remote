...
const NewComputerSetup = () => {
  const canonicalUrl = 'https://24x7techoncall.com/residential-support/new-computer-setup';
  const pageImage = heroImage?.startsWith('http') ? heroImage : `https://24x7techoncall.com${heroImage || ''}`;

  const whatWeHelp = [
    'Windows initial setup and account configuration',
    'Microsoft account setup and sync',
    'Essential software installation (browser, Office, PDF reader)',
    'Email account setup and configuration',
    'Printer and scanner setup on new computer',
    'OneDrive and cloud backup configuration',
    'File transfer from old computer (remote guidance)',
    'Browser setup and bookmarks import',
    'Windows Update and driver installation',
    'Security software installation and configuration',
    'Accessibility settings and display preferences',
    'Wi-Fi and network connection setup',
  ];
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6 py-12 max-w-6xl">
          <nav className="flex items-center gap-2 text-sm text-cyan-300 mb-3">
            ...
            <span className="text-gray-500">/</span>
            <span className="text-gray-300">New Computer Setup</span>
          </nav>
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight">New Computer Setup — Done Remotely</h1>
          <p className="mt-3 text-cyan-100 text-lg max-w-2xl">Got a new computer but not sure where to start? We'll configure everything remotely so it's ready to use right away.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2 max-w-xl mx-auto">We handle the technical setup so you can start using your new computer without the frustration.</p>
          </div>
      ...
      <section className="py-16 bg-gray-900 border-t-4 border-cyan-500 text-white text-center">
        <div className="container mx-auto px-6 max-w-2xl">
          ...
          <h2 className="text-3xl font-bold mb-4">New Computer? We'll Set It Up Right.</h2>
          <p className="text-gray-400 mb-8">Book a remote setup session today. We'll have your new computer fully configured and ready to use.</p>
