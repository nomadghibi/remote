...
const DataBackupTransfer = () => {
  const canonicalUrl = 'https://24x7techoncall.com/residential-support/data-backup-transfer';
  const pageImage = heroImage?.startsWith('http') ? heroImage : `https://24x7techoncall.com${heroImage || ''}`;

  const whatWeHelp = [
    'OneDrive setup, sync, and troubleshooting',
    'Google Drive and Dropbox setup and sync',
    'Cloud backup configuration and testing',
    'File transfer from old PC to new PC (remote guidance)',
    'Windows Backup and File History setup',
    'Photo and document backup to cloud or external drive',
    'Backup verification and restore testing',
    'Data migration planning for new computer setup',
    'Recovering files from cloud after accidental deletion',
    'Shared folder and network drive access setup',
  ];
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6 py-12 max-w-6xl">
          <nav className="flex items-center gap-2 text-sm text-cyan-300 mb-3">
            ...
            <span className="text-gray-500">/</span>
            <span className="text-gray-300">Data Backup & Transfer</span>
          </nav>
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight">Data Backup & File Transfer Support</h1>
          <p className="mt-3 text-cyan-100 text-lg max-w-2xl">We help you set up reliable backups and safely move your files to a new computer — all done remotely.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2 max-w-xl mx-auto">Never lose your files again. We set up the right backup strategy and help you move your data safely.</p>
          </div>
      ...
      <section className="py-16 bg-gray-900 border-t-4 border-cyan-500 text-white text-center">
        <div className="container mx-auto px-6 max-w-2xl">
          ...
          <h2 className="text-3xl font-bold mb-4">Don't Risk Losing Your Files.</h2>
          <p className="text-gray-400 mb-8">Let us set up a backup that runs automatically. Book a remote session today.</p>
...
export default DataBackupTransfer;
