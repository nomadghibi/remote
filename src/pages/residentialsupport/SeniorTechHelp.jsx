...
const SeniorTechHelp = () => {
  const canonicalUrl = 'https://24x7techoncall.com/residential-support/senior-tech-help';
  const pageImage = heroImage?.startsWith('http') ? heroImage : `https://24x7techoncall.com${heroImage || ''}`;

  const whatWeHelp = [
    'Email setup and how-to help (Gmail, Outlook, Yahoo)',
    'Zoom and video calling setup and troubleshooting',
    'Tablet and iPad basic setup and usage guidance',
    'Smart TV setup and streaming app help (Netflix, YouTube)',
    'Online safety — avoiding scams, phishing, and fraud',
    'Password setup and secure login help',
    'Photo organization and sharing with family',
    'Printing from computer or tablet',
    'Browser help — safe browsing, favorites, and search',
    'Voice assistant setup (Alexa, Google Home, Siri)',
    'Telehealth and online appointment navigation',
    'General how-to training at your own pace',
  ];
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6 py-12 max-w-6xl">
          <nav className="flex items-center gap-2 text-sm text-cyan-300 mb-3">
            ...
            <span className="text-gray-500">/</span>
            <span className="text-gray-300">Senior Tech Help</span>
          </nav>
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight">Tech Help for Seniors — Patient & Remote</h1>
          <p className="mt-3 text-cyan-100 text-lg max-w-2xl">We provide friendly, no-jargon remote tech support for seniors — whatever the device, wherever you are in the USA.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2 max-w-xl mx-auto">We take the time to explain everything clearly and make sure you feel comfortable and confident with your technology.</p>
          </div>
      ...
      <section className="py-16 bg-gray-900 border-t-4 border-cyan-500 text-white text-center">
        <div className="container mx-auto px-6 max-w-2xl">
          ...
          <h2 className="text-3xl font-bold mb-4">We're Here to Help — No Question Too Small.</h2>
          <p className="text-gray-400 mb-8">Patient, friendly remote support for seniors across the USA. Call us or book a session at your convenience.</p>
