...
const WifiInternetHelp = () => {
  const canonicalUrl = 'https://24x7techoncall.com/residential-support/wifi-internet-help';
  const pageImage = heroImage?.startsWith('http') ? heroImage : `https://24x7techoncall.com${heroImage || ''}`;

  const whatWeHelp = [
    'Slow internet speeds and buffering issues',
    'Wi-Fi dropping or disconnecting frequently',
    'Router configuration and password reset',
    'Cannot connect to Wi-Fi or internet',
    'Wi-Fi dead zones and weak signal areas',
    'Network printer not found on the network',
    'DNS errors and "No Internet" connectivity issues',
    'Guest network setup and parental controls',
    'Mesh network and Wi-Fi extender setup guidance',
    'VPN setup for home use',
    'IP conflict and DHCP troubleshooting',
    'ISP-related connectivity escalation advice',
  ];
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6 py-12 max-w-6xl">
          <nav className="flex items-center gap-2 text-sm text-cyan-300 mb-3">
            ...
            <span className="text-gray-500">/</span>
            <span className="text-gray-300">Wi-Fi & Internet Help</span>
          </nav>
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight">Wi-Fi & Internet Help — Remotely Fixed</h1>
          <p className="mt-3 text-cyan-100 text-lg max-w-2xl">Slow Wi-Fi, dropped connections, or router problems? We troubleshoot your home network remotely — no visit needed.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2 max-w-xl mx-auto">We remotely diagnose and fix most home network issues in one session.</p>
          </div>
      ...
      <section className="py-16 bg-gray-900 border-t-4 border-cyan-500 text-white text-center">
        <div className="container mx-auto px-6 max-w-2xl">
          ...
          <h2 className="text-3xl font-bold mb-4">Internet Running Slow? Let's Fix It Remotely.</h2>
          <p className="text-gray-400 mb-8">Call or book a session. We'll get your connection stable without stepping foot in your home.</p>
...
export default WifiInternetHelp;
