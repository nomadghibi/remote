...
const PcTuneUp = () => {
  const canonicalUrl = 'https://24x7techoncall.com/residential-support/pc-tune-up';
  const pageImage = heroImage?.startsWith('http') ? heroImage : `https://24x7techoncall.com${heroImage || ''}`;

  const whatWeHelp = [
    'Slow startup and long boot times',
    'Junk file and temporary file cleanup',
    'Startup program management and optimization',
    'Windows Update cleanup and error repair',
    'Bloatware and unwanted program removal',
    'Disk cleanup and storage optimization',
    'Browser cleanup — cache, extensions, and cookies',
    'RAM and CPU usage optimization',
    'Windows 10 to Windows 11 upgrade readiness check',
    'Windows 10 End of Support advisory (Oct 2025)',
    'System health report and recommendations',
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6 py-12 max-w-6xl">
          <nav className="flex items-center gap-2 text-sm text-cyan-300 mb-3">
            ...
            <span className="text-gray-500">/</span>
            <span className="text-gray-300">PC Tune-Up</span>
          </nav>
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight">PC Tune-Up & Performance Optimization</h1>
          <p className="mt-3 text-cyan-100 text-lg max-w-2xl">Is your computer slow, sluggish, or full of junk? We'll clean it up and speed it back up — 100% remotely.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2 max-w-xl mx-auto">A thorough remote tune-up gets your PC running like new — no hardware visit required.</p>
          </div>
      ...
      <section className="py-16 bg-gray-900 border-t-4 border-cyan-500 text-white text-center">
        <div className="container mx-auto px-6 max-w-2xl">
          ...
          <h2 className="text-3xl font-bold mb-4">Ready for a Faster Computer?</h2>
          <p className="text-gray-400 mb-8">Our remote tune-up takes about an hour. Book a session or call us and we'll get started right away.</p>
